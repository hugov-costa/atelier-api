...
/**
 * Validates that a date/time (or time-of-day) value is strictly earlier than a
 ...
 */
class BeforeDateTime implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if (! $target->lessThan($reference)) {
            $fail('The :attribute must be earlier than the end.');
        }
    }
}
